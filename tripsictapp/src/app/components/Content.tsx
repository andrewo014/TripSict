  ...
  return (
    <main className="content">
      <div className="newUser">
        <h1>
          Use our app to plan your <br /> next getaway!
        </h1>
        <p>
          With up-to-date information on lodging, <br /> food, and points of
          interest, <br /> travel planning has never been easier!
        </p>
